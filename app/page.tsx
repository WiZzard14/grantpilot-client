      ...
      <section className="hero-grid relative overflow-hidden border-b bg-white">
        <div className="mx-auto grid min-h-[65vh] max-w-7xl items-center gap-12 px-4 py-12 sm:px-6 lg:grid-cols-[1.1fr_.9fr] lg:px-8">
          ...
          <div className="floating rounded-[2rem] border border-slate-200 bg-white p-5 shadow-2xl shadow-slate-300/50">
            <div className="rounded-2xl bg-slate-950 p-5 text-white"><div className="flex items-center justify-between"><span className="font-bold">Match Agent</span><BrainCircuit className="text-teal-300" /></div><p className="mt-4 text-5xl font-black">91%</p><p className="mt-1 text-sm text-slate-300">Academic, funding, and location alignment</p></div>
